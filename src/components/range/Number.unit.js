...
import RangeComponent from './Number';
...
describe('Number Component', () => {
  it('Should build an number component', () => {
    return Harness.testCreate(RangeComponent, comp1).then((component) => {
      Harness.testElements(component, 'input[type="text"]', 1);
    });
  });

  it('Should format submissions for table view for French locale', () => {
    return Harness.testCreate(RangeComponent, comp4, { language: 'fr' }).then((component) => {
  ...
  it('Should format sumbissions for table view for USA locale', () => {
    return Harness.testCreate(RangeComponent, comp4, { language: 'en-US' }).then((component) => {
      const value1 = component.getValueAsString(1);
      const value2 = component.getValueAsString(1.1);
      const value3 = component.getValueAsString(1.11);
      const value4 = component.getValueAsString(1111);
  ...
  it('Should format value on blur for French locale', (done) => {
    Harness.testCreate(RangeComponent, comp4, { language: 'fr' }).then((component) => {
      component.root = {
        onChange: ()=>{},
        triggerChange: ()=>{},
      };
  ...
  it('Should not change entered value on blur if multiple value is set', (done) => {
    Harness.testCreate(RangeComponent, comp5).then((component) => {
      component.root = {
        onChange: ()=>{},
        triggerChange: ()=>{},
      };
  ...
  it('Should limit decimals using step', () => {
    return Harness.testCreate(RangeComponent, _merge({}, comp2, {
      validate: {
        step: '0.001'
      }
    })).then((component) => {
  ...
  it('Should format submissions for table view for French locale', () => {
    return Harness.testCreate(RangeComponent, comp2, { language: 'fr' }).then((component) => {
      const value1 = component.getValueAsString(1);
      const value2 = component.getValueAsString(1.1);
  ...
  it('Should format sumissions for table view for USA locale', () => {
    return Harness.testCreate(RangeComponent, comp2, { language: 'en-US' }).then((component) => {
      const value1 = component.getValueAsString(1);
      const value2 = component.getValueAsString(1.1);
      const value3 = component.getValueAsString(1.1111111);
      const value4 = component.getValueAsString(1111);
  ...
  it('Should format numbers for British locale', () => {
    return Harness.testCreate(RangeComponent, comp2, { language: 'en-GB' }).then((component) => {
      Harness.testSetInput(component, null, null, '');
      Harness.testSetInput(component, 0, 0, '0');
      Harness.testSetInput(component, 1, 1, '1');
      Harness.testSetInput(component, -1, -1, '-1');
  ...
  it('Should format numbers for German locale', () => {
    return Harness.testCreate(RangeComponent, comp2, { language: 'de' }).then((component) => {
      Harness.testSetInput(component, null, null, '');
      Harness.testSetInput(component, 0, 0, '0');
      Harness.testSetInput(component, 1, 1, '1');
      Harness.testSetInput(component, -1, -1, '-1');
  ...
  it('Should display default integer value', () => {
    return Harness.testCreate(RangeComponent, comp3).then(number => {
  ...
  it('Should display default decimal value', () => {
    ...
    return Harness.testCreate(RangeComponent, comp).then(number => {
  ...
  it('Should return value as string properly for multiple values', (done) => {
    Harness.testCreate(RangeComponent, comp7).then((component) => {
  ...
  //   comp.requireDecimal = true;
  //
  //   Harness.testCreate(RangeComponent, comp).then(number => {
  //     const testset = [
  //       // [inv, outv, display]
  //       ['42',        42,       '42.00'],
  //       ['42.1',      42.1,     '42.10'],
  ...
  //   Harness.testCreate(RangeComponent, comp4).then(number => {
  //     const testset = [
  //       ['42',        42,       '42.00'],
  //       ['42.1',      42.1,     '42.10'],
  //       ['42.01',     42.01,    '42.01'],
