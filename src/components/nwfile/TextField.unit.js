...
import NWFileComponent from './TextField';
...
describe('TextField Component', () => {
  it('Should create a new TextField', () => {
    const textField = new NWFileComponent({
      label: 'First Name',
      key: 'firstName',
      input: true,
      type: 'textfield'
  ...
  it('Should build a TextField component', () => {
    return Harness.testCreate(NWFileComponent, comp1).then((component) => {
      Harness.testElements(component, 'input[type="text"]', 1);
    });
  });

  it('Should disable multiple mask selector if component is disabled', (done) => {
    Harness.testCreate(NWFileComponent, comp4).then((component) => {
  ...
  it('Should provide required validation', () => {
    return Harness.testCreate(NWFileComponent, _.merge({}, comp2, {
  ...
  it('Should correctly calculate remaining words', (done) => {
    Harness.testCreate(NWFileComponent, comp5).then((component) => {
